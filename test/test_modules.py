...
@pytest.mark.parametrize(
    ("partition_number", "packet1", "packet2", "expected_same_partition"),
    (
        (
            10,
...
def test_partitioning(partition_number, packet1, packet2, expected_same_partition):
    kafka_manager = KafkaManager([], partition_number)
